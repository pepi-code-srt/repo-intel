...
|------------|--------|-----------------|----------------|
| `octocat/Hello-World` | **SUCCESS** | 7 WebSocket events | 7.56s |
| `pallets/click` | **SUCCESS** | 7 WebSocket events | 8.13s |
...
2. Observed wall-clock durations were 7.56s and 8.13s, with 7 WebSocket events captured for each run.
